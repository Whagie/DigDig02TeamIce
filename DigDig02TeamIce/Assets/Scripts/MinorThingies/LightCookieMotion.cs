...
public class LightCookieMotion : MonoBehaviour
{
    ...
    void Update()
    {
        m_time1U = Time.time % m_cycleDuration1UV.x; m_time1U /= m_cycleDuration1UV.x;
        m_time1V = Time.time % m_cycleDuration1UV.y; m_time1V /= m_cycleDuration1UV.y;
        m_time2U = Time.time % m_cycleDuration2UV.x; m_time2U /= m_cycleDuration2UV.x;
        m_time2V = Time.time % m_cycleDuration2UV.y; m_time2V /= m_cycleDuration2UV.y;
        UpdateMaterial();
    }
